...
%g2=gs(i2);
   g2 = gcomp(i1,i2);
    [MeP11(i1,i2),MeP22(i1,i2)] = simulateMHC_ifn(g1,g2,u1,u2,gM);
  end
end
...
%g2=gs(i2);
   g2 = gcomp(i1,i2);
    [MeP11(i1,i2),MeP22(i1,i2),M(i1,i2),T(i1,i2),MT(i1,i2)] = simulateMHC_ifn(sf1*g1,sf2*g2,u1,u2,sf(1));
  end
end
